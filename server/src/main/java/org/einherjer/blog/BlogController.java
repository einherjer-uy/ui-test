...
import org.einherjer.blog.persistence.BlogPostDAO;
import org.einherjer.blog.persistence.SessionDAO;
import org.einherjer.blog.persistence.UserDAO;
...
public class BlogController {
    ...
    public static void main(String[] args) throws IOException {
        new ClassPathXmlApplicationContext("main-context.xml", "main-beans.xml");
        new BlogController();
    }
    ...
    abstract class JSONRoute extends Route {
        ...
        protected JSONRoute(final String path) throws IOException {
            super(path);
        }
        ...
        protected abstract Object doHandle(final Request request, final Response response) throws IOException;
    ...
    private void initializeRoutes() throws IOException {
        ...
        get(new JSONRoute("/") {
            @Override
            public Object doHandle(Request request, Response response) throws IOException {
