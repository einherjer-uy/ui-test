...
(function ($) { "use strict";
	...
	app.ActionsView = Backbone.View.extend({
		...
		render: function () {
			...
			this.$cancelAction.popover({placement:"left", container: false, title:"Confirmation", html:true, 
				content:popoverView.render().el}).parent().on('click', 'button.confirmCancelButton', function() {
    console.log('World!');
});;
